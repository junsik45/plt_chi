...
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'S1','LL', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'S2','LL', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'S3','LL', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'S4','LL', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'U1','LL', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'S1','LR', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'S2','LR', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'S3','LR', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'S4','LR', 'imag')
plot_ch_val(ME_proj_tr_list, ME_proj_tr_var_list, 'U1','LR', 'imag')
